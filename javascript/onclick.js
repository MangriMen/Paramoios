...
document.getElementById('cancel-item').addEventListener('click', addNewItemToInventory(0));
document.getElementById('confirm-item').addEventListener('click', addNewItemToInventory(1));
let x = 0;
let y = 0;
